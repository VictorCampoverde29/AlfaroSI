...
namespace ALFARO_CAJA.REPORTES {
    ...
    public class LIQAMPOLLAS : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ALFARO_CAJA.REPORTES.LIQAMPOLLAS.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLIQAMPOLLAS : Component, ICachedReport {
        
        public CachedLIQAMPOLLAS() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LIQAMPOLLAS rpt = new LIQAMPOLLAS();
            rpt.Site = this.Site;
            return rpt;
        }
