...
namespace ALFARO_CAJA.REPORTES {
    ...
    public class LIQPROSANIT : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ALFARO_CAJA.REPORTES.LIQPROSANIT.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLIQPROSANIT : Component, ICachedReport {
        
        public CachedLIQPROSANIT() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LIQPROSANIT rpt = new LIQPROSANIT();
            rpt.Site = this.Site;
            return rpt;
        }
